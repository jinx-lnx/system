...
/opt/gwn/python/fetch-images.py \
        --repo-base http://img.getwellnetwork.com/PLC-INSTALLER \
        --local-repo /opt/plc-root/opt/assets/plc-installer --purge-local ${PROXY} \
        ${HOSTID} ${*}

# Adjust the permissions
find /opt/plc-root/opt/assets/plc-installer -maxdepth 1 -exec chgrp www-data {} \;
