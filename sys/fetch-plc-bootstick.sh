...
/opt/gwn/python/fetch-images.py \
        --repo-base http://img.getwellnetwork.com/PLC-BOOTSTICK \
        --local-repo /opt/plc-root/opt/assets/plc-bootstick --purge-local ${PROXY} \
        ${HOSTID} ${*}

# Adjust the permissions
find /opt/plc-root/opt/assets/plc-bootstick -maxdepth 1 -exec chgrp www-data {} \;
